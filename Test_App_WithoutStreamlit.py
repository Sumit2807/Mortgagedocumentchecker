...
uploaded_files=["ScannedSampleDocs/Scanned_PDF_Scenario_02062024_2.png"]
...
for i in range(1, 4):
    ...
    previous_month_date = datetime.datetime(year, month, 1)
...
if  uploaded_files:
    for uploaded_file in uploaded_files:
        ...
        if is_digital_pdf(uploaded_file): 
            ...
            if file_extension.lower()in [".jpg",".jpeg",".pdf",".png"]:
                ...
                if file_extension.lower()==".pdf":
                   convertedimages=convert_pdf_to_images(uploaded_file,'ScannedSampleDocs','png')
                   ...
                   for convertimage in convertedimages:
                    ...
                    #    Clean the GPT4 vision output
                        ...
                        #Call GPT4 Vision
                        imageresponse=process_image_with_gpt4vision(uploaded_file)
                            #    Clean the GPT4 vision output
                        cleanresponse=extract_json_structure(imageresponse)
        ...
        try:    
                ...
                st.error(file_name)
                st.markdown(format_status(False, "Invalid document  provided, please check.", "Invalid document format provided, please check.", "Error"), unsafe_allow_html=True)
